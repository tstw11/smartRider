...
<body>
	...
	<header class="masthead"
		style="background-image: url('resources/img/club2.jpg')">
		...
		<div class="row">
			<div class="col">
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							<th scope="row" class="table-secondary" role="alert">클럽 이름</th>
							<td>${data.club.club_name }</td>
							<th scope="row" class="table-secondary" role="alert">닉네임</th>
							<td>${data.member.member_nick }</td>
						</tr>
						<tr>
							<th scope="row" class="table-secondary">작성자</th>
							<td>${data.club.club_manager }</td>
							<th scope="row" class="table-secondary">생성일</th>
							<td><fmt:formatDate value="${data.club.club_date }"
									pattern="yyyy-MM-dd"></fmt:formatDate></td>
						</tr>
						<tr>
							<th scope="row" class="table-secondary">홈페이지</th>
							<td colspan="3">${data.club.club_page }</td>
						</tr>
						<tr>
							<th scope="row" class="table-secondary">대표 번호</th>
							<td colspan="3">${data.club.club_phone }</td>
						</tr>
						<tr>
							<td colspan="4"><textarea readonly class="form-control"
									name="board_content" rows="20" cols="110">${data.club.club_introduce }</textarea>
							</td>
						</tr>
					</tbody>
				</table>
